                ...
                <form class="form-horizontal frm_update_personal_information" action="updateprofile" method="POST">
                    ...
                    <div class="col-md-12">
                        <div class="form-group field-profileform-firstname required">
                            ...
                            <div class="col-md-7 ">
                                <input type="text"  value="{{ $guide->first_name }}" id="profileform-first_name" class="form-control" name="first_name">
                        ...
                        <div class="form-group field-profileform-lastname required">
                            ...
                            <div class="col-md-7 ">
                                <input type="text"  value="{{ $guide->last_name }}" id="profileform-last_name" class="form-control" name="last_name">
                        ...
                        <div class="form-group field-profileform-email required">
                            ...
                            <div class="col-md-7 ">
                                <input type="email"  value="{{ $guide->email}}" id="profileform-email" class="form-control" name="email">
                        ...
                        <div class="form-group field-profileform-city required">
                            ...
                            <div class="col-md-7 ">
                                <input type="text"  value="{{ $guide->city }}" id="profileform-city" class="form-control" name="city">
                        ...
                        <div class="form-group field-profileform-address required">
                            ...
                            <div class="col-md-7 ">
                                <input type="text"  value="{{ $guide->address }}" id="profileform-address" class="form-control" name="address">
                        ...
                        <div class="form-group field-profileform-contact required">
                            ...
                            <div class="col-md-7 ">
                                <input type="text"  value="{{ $guide->phone_number }}" id="profileform-phone_number" class="form-control" name="phone_number">
                ...
                <form class="form-horizontal frm_change_password" action="savepassword" method="POST">
                    ...
                    <div class="col-md-12">
                        <div class="form-group field-changepasswordform-oldpass required">
                            ...
                            <div class="col-md-7 ">
                                <input type="password"  value="{{ old('old_password') }}" id="changepasswordform-oldpass" class="form-control" name="old_password">
                        ...
                        <div class="form-group field-changepasswordform-newpass required">
                            ...
                            <div class="col-md-7">
                                <input type="password" value="{{ old('password') }}" id="changepasswordform-newpass" class="form-control" name="password">
                        ...
                        <div class="form-group field-changepasswordform-repeatnewpass required">
                            ...
                            <div class="col-md-7">
                                <input type="password" value="{{ old('password_confirmation') }}" id="changepasswordform-repeatnewpass" class="form-control" name="password_confirmation">
