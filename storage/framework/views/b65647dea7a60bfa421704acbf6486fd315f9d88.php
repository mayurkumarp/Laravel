        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php echo e(ucfirst($user['first_name'])." ".ucfirst($user['last_name'])); ?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                    <?php echo e(ucfirst($user['first_name'])." ".ucfirst($user['last_name'])); ?> - <?= ucfirst($guard)?> 
              ...
              <li class="user-footer">
                <div class="pull-left">
                    <?php if(!Request::is('admin/*')): ?>
                        <a href="<?php echo e(url("$url")); ?>/profile" class="btn btn-default btn-flat">Profile</a>
                    <?php else: ?>
                        <a href="<?php echo e(url("$url")); ?>/change-password" class="btn btn-default btn-flat">Change Password</a>
                    <?php endif; ?>
                </div>
                <div class="pull-right">
                  <a href="<?php echo e(url("$url")); ?>/logout" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
